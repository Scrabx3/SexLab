...
Function EnjoymentSettings()
	...
	AddHeaderOption("Primary Settings")
		...
		AddSliderOptionST("EnjRaiseMultNonInter", "$SSL_EnjRaiseMultNonInter", Config.EnjRaiseMultNonInter)
	...
	AddHeaderOption("Game Toggles")
		...
		AddToggleOptionST("GameEnabledNPC","$SSL_GameEnabledNPC", Config.GameEnabledNPC)
		AddToggleOptionST("GamePlayerAutoplay","$SSL_GamePlayerAutoplay", Config.GamePlayerAutoplay)
		AddToggleOptionST("GameVictimAutoplay","$SSL_GameVictimAutoplay", Config.GameVictimAutoplay)
...
Event OnSelectST()
	...
	ElseIf (s[0] == "GameEnabledNPC")
		Config.GameEnabledNPC = !Config.GameEnabledNPC
		SetToggleOptionValueST(Config.GameEnabledNPC)
	...
	ElseIf (s[0] == "GameVictimAutoplay")
		Config.GameVictimAutoplay = !Config.GameVictimAutoplay
		SetToggleOptionValueST(Config.GameVictimAutoplay)
...
Event OnSliderOpenST()
	...
	ElseIf (s[0] == "EnjRaiseMultNonInter")
		SetSliderDialogStartValue(Config.EnjRaiseMultNonInter)
		SetSliderDialogRange(0.0, 3.0)
		SetSliderDialogInterval(0.1)
...
Event OnSliderAcceptST(float value)
	...
	ElseIf (s[0] == "EnjRaiseMultNonInter")
		Config.EnjRaiseMultNonInter = value
		SetSliderOptionValueST(Config.EnjRaiseMultNonInter, "{1}")
	ElseIf (s[0] == "EnjGainOnStageSkip")
