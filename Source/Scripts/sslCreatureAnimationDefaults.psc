...
function SpiderDouble(int id)
	...
	int a1 = Base.AddPosition(Female, VaginalOralAnal)
	Base.AddPositionStage(a1, "Spider_Double_A1_S1", openmouth=true)
	Base.AddPositionStage(a1, "Spider_Double_A1_S2", openmouth=true)
	Base.AddPositionStage(a1, "Spider_Double_A1_S3", openmouth=true)
	Base.AddPositionStage(a1, "Spider_Double_A1_S4", openmouth=true)

	int a2 = Base.AddCreaturePosition("Spiders", Creature)
	Base.AddPositionStage(a2, "Spider_Double_A2_S1", 80.0, rotate=180.0)
	Base.AddPositionStage(a2, "Spider_Double_A2_S2", 80.0, rotate=180.0)
	Base.AddPositionStage(a2, "Spider_Double_A2_S3", 80.0, rotate=180.0)
	Base.AddPositionStage(a2, "Spider_Double_A2_S4", 80.0, rotate=180.0)

	int a3 = Base.AddCreaturePosition("Spiders", Creature)
	Base.AddPositionStage(a3, "Spider_Double_A3_S1", 37.0, rotate=180.0)
	Base.AddPositionStage(a3, "Spider_Double_A3_S2", 37.0, rotate=180.0)
	Base.AddPositionStage(a3, "Spider_Double_A3_S3", 37.0, rotate=180.0)
	Base.AddPositionStage(a3, "Spider_Double_A3_S4", 37.0, rotate=180.0)
